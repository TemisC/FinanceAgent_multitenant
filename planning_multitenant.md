...
## ?? Tareas Pendientes (Backlog de Automatizaci�n)

### 1. Sincronizaci�n de Ingresos Reales (n8n + Gumroad)
*   **Estado:** Dashboard listo, falta conexi�n Backend.
*   **Acci�n:** Configurar nodo de **Supabase (Insert Row)** en n8n para la tabla \public.ventas\.
...
### 2. Validaci�n de Webhook de Renovaci�n
*   **Estado:** Planeado.
*   **Acci�n:** Asegurar que cuando un usuario renueva su suscripci�n anual/mensual, n8n extienda la \echa_vencimiento\ sumando 30 d�as adicionales a la fecha actual.
