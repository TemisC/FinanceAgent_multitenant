          ...
          >
            ...
            <div className="grid grid-cols-[auto_1fr_auto] items-center gap-4">
              ...
              <div className="flex flex-col items-end gap-1.5 min-w-[80px]">
                ...
                {expense.moneda_original && expense.moneda_original !== currency && (
                  <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest bg-white/5 px-1.5 py-0.5 rounded">
                    {parseFloat(expense.monto_original).toLocaleString()} {expense.moneda_original}
                  </span>
                )}
